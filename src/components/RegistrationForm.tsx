...
const RegistrationForm = () => {
  ...
  const handleUserRegister: SubmitHandler<FormFields> = async (data) => {
    ...
    await axios
      ...
      .then((response) => {
        if (response.status == 201) setSuccessful("You've been registered!");
      })
      .catch((error) => {
    ...
    >
      ...
      <div className="registration-form__wrap">
        <div className="registration-form__left">
          ...
          {successful !== '' ? (
            <p
              ...
              className="registration-form__success-message"
            >
              {successful}
            </p>
          ) : null}
        ...
        <div className="registration-form__right">
          <label
            htmlFor="file-input"
            className="registration-form__profile-picture"
          >
            <span>
              <UploadIcon />
            </span>
          ...
          <input
            ...
            className="registration-form__text-input profile-picture"
          />
